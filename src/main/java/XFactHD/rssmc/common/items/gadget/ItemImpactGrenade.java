...
public class ItemImpactGrenade extends ItemBase
{
    public ItemImpactGrenade()
    {
        super("itemImpactGrenade", 8, RainbowSixSiegeMC.CT.gadgetTab, null);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World world, EntityPlayer player, EnumHand hand)
    {
        if (!world.isRemote)
        {
            EntityImpactGrenade grenade = new EntityImpactGrenade(world, player);
