...
public class ItemBlockWall extends ItemBlockBase
{
    public ItemBlockWall(BlockBase block)
    {
        super(block);
    }
    ...
    public String getUnlocalizedName(ItemStack stack)
    {
        ...
        return getUnlocalizedName() + "_" + EnumMaterial.WALL_MATERIAL.get(stack.getMetadata()).getName() + "_" + type.getName();
    }
