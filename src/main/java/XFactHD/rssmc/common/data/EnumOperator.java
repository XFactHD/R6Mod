...
public enum EnumOperator
{
    ...
    CAVEIRA   ("Caveira",  EnumSide.DEFFENDER, EnumArmorLevel.LIGHT,  new EnumGun[]{EnumGun.M12, EnumGun.SPAS_15},                       new EnumGun[]{EnumGun.PRB92},                    new EnumGadget[]{EnumGadget.IMPACT_GRENADE, EnumGadget.BARBED_WIRE},       EnumGadget.INTEROGATION_KNIVE),
    ...
    VIGIL     ("Vigil",    EnumSide.DEFFENDER, EnumArmorLevel.LIGHT,  new EnumGun[]{}, new EnumGun[]{}, new EnumGadget[]{}, null),
    ...
    ZOFIA     ("Zofia",      EnumSide.ATTACKER, EnumArmorLevel.MEDIUM, new EnumGun[]{}, new EnumGun[]{}, new EnumGadget[]{}, null),
    DOKKAEBI  ("Dokkaebi",   EnumSide.ATTACKER, EnumArmorLevel.MEDIUM, new EnumGun[]{}, new EnumGun[]{}, new EnumGadget[]{}, null),
