...
public class EntityDroneCam extends AbstractEntityCamera
{
    public EntityDroneCam(World world)
    {
        super(world);
    }

    public EntityDroneCam(World world, UUID owner)
    {
        super(world, owner);
    }
    ...
    {
        return StatusController.getPlayersSide(player) != EnumSide.DEFFENDER;
    }
    ...
    {
        return canBeViewedBy(player) && !player.isSpectator();
    }
