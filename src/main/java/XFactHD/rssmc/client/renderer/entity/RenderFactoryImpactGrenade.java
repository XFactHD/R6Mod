...
public class RenderFactoryImpactGrenade implements IRenderFactory<EntityImpactGrenade>
{
    @Override
    public Render<? super EntityImpactGrenade> createRenderFor(RenderManager manager)
    {
        return new RenderSnowball<>(manager, Content.itemImpactGrenade, Minecraft.getMinecraft().getRenderItem());
    }
}