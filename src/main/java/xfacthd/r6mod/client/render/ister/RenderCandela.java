...
public class RenderCandela extends ItemStackTileEntityRenderer
{
    ...
    private static IBakedModel model_0;
    ...
    @Override
    public void func_239207_a_(ItemStack stack, ItemCameraTransforms.TransformType transform, MatrixStack matrix, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay)
    {
    ...
    {
        ModelLoader.addSpecialModel(new ResourceLocation(R6Mod.MODID, "item/item_candela_0"));
    ...
    {
        model_0 = registry.get(new ResourceLocation(R6Mod.MODID, "item/item_candela_0"));
