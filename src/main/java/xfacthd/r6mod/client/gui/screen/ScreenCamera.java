...
import xfacthd.r6mod.common.net.packets.camera.PacketCameraTeamGuiResult;

import java.util.Collection;

public class ScreenCamera extends ContainerScreen<ContainerCamera> implements Button.IPressable
{
    private static final ResourceLocation TEXTURE = new ResourceLocation(R6Mod.MODID, "textures/gui/gui_camera.png");
    private static final String HEADER = I18n.format("gui.r6mod.camera.header");
    private static final String NO_TEAM = I18n.format("gui.r6mod.camera.no_team");
    ...
    public ScreenCamera(ContainerCamera container, PlayerInventory inv, ITextComponent title)
    {
    ...
    protected void init()
    {
        int listWidth = Math.max(50, font.getStringWidth(NO_TEAM) + 30);
    ...
    public void onClose()
    {
        ...
        NetworkHandler.sendToServer(new PacketCameraTeamGuiResult(result));
    }
}