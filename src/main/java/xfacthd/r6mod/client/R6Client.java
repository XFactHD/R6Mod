...
public class R6Client
{
    ...
    public static void onClientSetup(final FMLClientSetupEvent event)
    {
        ...
        DeferredWorkQueue.runLater(() ->
        {
            ...
            //manager.register(EntityTypes.entityTypeFragGrenade, new RenderEntityGrenade<>(manager, mc().getItemRenderer()));
            //manager.register(EntityTypes.entityTypeStunGrenade, new RenderEntityGrenade<>(manager, mc().getItemRenderer()));
            //manager.register(EntityTypes.entityTypeSmokeGrenade, new RenderEntityGrenade<>(manager, mc().getItemRenderer()));
            manager.register(EntityTypes.entityTypeImpactGrenade, new RenderEntityGrenade<>(manager, mc().getItemRenderer()));
            ...
            manager.register(EntityTypes.entityTypeEMPGrenade, new RenderEntityGrenade<>(manager, mc().getItemRenderer()));
            manager.register(EntityTypes.entityTypeCandelaGrenade, new RenderEntityCandela(manager));
            manager.register(EntityTypes.entityTypeCandelaFlash, new RenderEntityCandelaFlash(manager));
    ...
    public static void onTextureMapReloadPre(final TextureStitchEvent.Pre event)
    {
        if (event.getMap().getTextureLocation() == AtlasTexture.LOCATION_BLOCKS_TEXTURE)
        {
            ...
            EffectCandelaFlash.registerTextures(event);
        }
    ...
    public static void onTextureMapReloadPost(final TextureStitchEvent.Post event)
    {
        if (event.getMap().getTextureLocation() == AtlasTexture.LOCATION_BLOCKS_TEXTURE)
        {
            ...
            EffectCandelaFlash.loadTextures(event.getMap());
        }
        else if (event.getMap().getTextureLocation() == AtlasTexture.LOCATION_PARTICLES_TEXTURE)
        {
