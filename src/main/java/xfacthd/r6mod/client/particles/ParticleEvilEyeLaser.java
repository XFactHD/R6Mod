...
public class ParticleEvilEyeLaser extends Particle
{
    ...
    public ParticleEvilEyeLaser(ClientWorld world, double posX, double posY, double posZ, float yaw, float pitch)
    {
    ...
    public static class Factory implements IParticleFactory<ParticleDataEvilEyeLaser>
    {
        @Nullable
        @Override
        public Particle makeParticle(ParticleDataEvilEyeLaser data, ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed)
        {
