...
public class BlockFloorPanel extends BlockBase implements IDestructable
{
    ...
    {
        super("block_floor_panel_" + material.getName(),
    ...
    @Override //Final modifier removed via AT
    public boolean isSolid(BlockState state) { return !state.get(PropertyHolder.DESTROYED); }
