...
public class BlockWall extends BlockBase implements IDestructable
{
    ...
    {
        super("block_wall_" + (barred ? "barred_" : "soft_") + material.getName(),
    ...
    @Override
    public float getBlockHardness(BlockState state, IBlockReader world, BlockPos pos) { return barred ? 5 : 2; }
