...
import xfacthd.r6mod.common.items.building.*;
...
public class R6Content
{
    ...
    public static Item itemYingGlasses;                                 //STATUS: Complete
    ...
    public static void onRegisterEntityTypes(final RegistryEvent.Register<EntityType<?>> event)
    {
        ...
        EntityTypes.entityTypeCandelaGrenade = EntityTypes.createGrenade((type, world) -> new EntityCandelaGrenade(world), "entity_candela");
        EntityTypes.entityTypeCandelaFlash = EntityTypes.create((type, world) -> new EntityCandelaFlash(world), "entity_candela_flash", .1F, .1F, 1, true);
