...
public final class BarricadeStateProvider extends R6BlockStateProvider
{
    ...
    protected void registerStatesAndModels()
    {
        ...
        generateBarricadeStates(
                ...
                glassPane,
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_top")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_bottom")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_top_window")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_bottom_window")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_bottom_door")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_left_top")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_right_top")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_center_top")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_left_bottom")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_right_bottom")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_center_bottom")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_left_bottom_door")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_right_bottom_door")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_center_bottom_door")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_left_top_window")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_right_top_window")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_center_top_window")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_left_bottom_window")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_right_bottom_window")),
                models().getExistingFile(modLoc("block/gadget/block_tough_barricade_center_bottom_window"))
        );
    }
