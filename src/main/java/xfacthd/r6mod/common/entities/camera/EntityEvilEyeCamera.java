...
public class EntityEvilEyeCamera extends AbstractEntityCamera<EntityEvilEyeCamera>
{
    ...
    @Override
    public ICameraOverlay<EntityEvilEyeCamera> createOverlayRenderer() { return new OverlayEvilEye(); }
