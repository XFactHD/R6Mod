...
public class EntityYokaiDrone extends AbstractEntityCamera implements IShootable, IPickupTime
{
    ...
    public EntityYokaiDrone(World world, PlayerEntity thrower, String team)
    {
        ...
        setMotion(new Vec3d(x, y, z).normalize().scale(0.5D));
    }
    ...
    public ICameraOverlay createOverlayRenderer() { return new OverlayYokaiDrone(); }
    ...
    public InteractState pickUp(PlayerEntity player)
    {
        if (player.getUniqueID().equals(owner))
        {
            ...
            if (getCurrentTime() < getPickupTime()) { return InteractState.IN_PROGRESS; }
