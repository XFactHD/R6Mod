...
public class EntityBulletproofCamera extends AbstractEntityCamera<EntityBulletproofCamera>
{
    ...
    @Override
    public ICameraOverlay<EntityBulletproofCamera> createOverlayRenderer() { return new OverlayBulletproofCamera(); }
