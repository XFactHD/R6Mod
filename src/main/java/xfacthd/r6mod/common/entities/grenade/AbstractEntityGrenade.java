...
public abstract class AbstractEntityGrenade extends Entity implements IMagNetCatchable
{
    ...
    public void tick()
    {
        ...
        {
            boolean wasCollided = collidedHorizontally || collidedVertically;

            tickMovement();
            tickTimer();

            if (!wasCollided && collidedHorizontally || collidedVertically) { onImpact(); }
        }
    }
    ...
    @Override
    public void catchObject(Vector3d magPos)
    {
        caught = true;
