...
public class TileEntityBanshee extends TileEntityGadget
{
    ...
    public void tick()
    {
        ...
        {
            final Vec3d center = getCenterVec();
            ...
            if (!entities.isEmpty())
            {
                entities.forEach((e) ->
                {
                    ...
                    e.setMotionMultiplier(getBlockState(), new Vec3d(mult, mult, mult));
                });
            }
        }
