...
public class PacketRayTraceResult extends AbstractPacket
{
    ...
    public PacketRayTraceResult(Vec3d start, Vec3d end)
    {
        this.start = start;
        this.end = end;
    }
    ...
    {
        this.start = new Vec3d(bb.minX, bb.minY, bb.minZ);
        this.end = new Vec3d(bb.maxX, bb.maxY, bb.maxZ);
    }
    ...
    public void decode(PacketBuffer buffer)
    {
        ...
        end = new Vec3d(buffer.readDouble(), buffer.readDouble(), buffer.readDouble());
    }
