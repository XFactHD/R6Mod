...
public class Config
{
    ...
    private final ForgeConfigSpec.BooleanValue usageTimeValue;
    ...
    public Config(final ForgeConfigSpec.Builder builder)
    {
        ...
        usageTimeValue = builder
                .comment("If true, placing, using and picking up gadgets will take time")
                .translation("config.r6mod.usage_time")
                .define("usageTime", true);
        builder.pop();
