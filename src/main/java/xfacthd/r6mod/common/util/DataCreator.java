...
public class DataCreator
{
    ...
    public static void onGatherData(final GatherDataEvent event)
    {
        ...
        gen.addProvider(new BarricadeStateProvider(gen, R6Mod.MODID, event.getExistingFileHelper()));
        gen.addProvider(new ToughBarricadeStateProvider(gen, R6Mod.MODID, event.getExistingFileHelper()));
        gen.addProvider(new EmptyGunModelProvider(gen, R6Mod.MODID, event.getExistingFileHelper()));
        gen.addProvider(new WallStateProvider(gen, R6Mod.MODID, event.getExistingFileHelper()));
        gen.addProvider(new BlackMirrorStateProvider(gen, R6Mod.MODID, event.getExistingFileHelper()));
        gen.addProvider(new ReinforcementStateProvider(gen, R6Mod.MODID, event.getExistingFileHelper()));
        gen.addProvider(new FloorPanelStateProvider(gen, R6Mod.MODID, event.getExistingFileHelper()));
    }
        ...
        protected void registerStatesAndModels()
        {
            ...
            for (WallMaterial material : WallMaterial.values())
            {
                ...
                ModelFile wallSoft = models()
                        .withExistingParent(modLoc("block/building/block_wall_soft_" + material.getName()).toString(), modLoc("block/building/block_wall_soft"))
                ...
                ModelFile wallBarred = models()
                        .withExistingParent(modLoc("block/building/block_wall_barred_" + material.getName()).toString(), modLoc("block/building/block_wall_barred"))
                        .texture("surface", material.getTexture());
    ...
    private static final class BlackMirrorStateProvider extends BlockStateProvider
    {
        ...
        protected void registerStatesAndModels()
        {
            ...
            for (Direction facing : PropertyHolder.FACING_HOR.getAllowedValues())
            {
                ...
                for (WallMaterial material : WallMaterial.values())
                {
                    ModelFile intactLeft = models().getExistingFile(modLoc("block/gadget/block_black_mirror_left_" + material.getName()));
                    ModelFile intactRight = models().getExistingFile(modLoc("block/gadget/block_black_mirror_right_" + material.getName()));
                    ModelFile brokenLeft = models().getExistingFile(modLoc("block/gadget/block_black_mirror_left_destroyed_" + material.getName()));
                    ModelFile brokenRight = models().getExistingFile(modLoc("block/gadget/block_black_mirror_right_destroyed_" + material.getName()));
    ...
    private static final class ReinforcementStateProvider extends BlockStateProvider
    {
        ...
        protected void registerStatesAndModels()
        {
            ...
            {
                ModelFile model = models().getExistingFile(modLoc("block/building/block_reinforcement_" + segment.getName()));
                ...
                for (Direction facing : Direction.Plane.HORIZONTAL)
                {
                    ...
                    for (WallMaterial material : WallMaterial.values())
                    {
                        ModelFile wallModel = models().getExistingFile(modLoc("block/building/block_wall_soft_" + material.getName()));
        ...
        protected void registerStatesAndModels()
        {
            ...
            for (WallMaterial material : WallMaterial.values())
            {
                ...
                ModelFile model = models()
                        .withExistingParent(modLoc("block/building/block_floor_panel_" + material.getName()).toString(), modLoc("block/building/block_floor_panel"))
                        .texture("surface", material.getTexture());
